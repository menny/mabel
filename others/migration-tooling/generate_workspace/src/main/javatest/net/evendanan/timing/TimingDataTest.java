...
public class TimingDataTest {
    ...
    public void testCtor() {
        ...
        assertTimingData(data,
            2, 1, 10, 20, 15, 0.7f);
    }

    static void assertTimingData(final TimingData data,
                                 int totalTasks, int doneTasks, long startTime, long totalTime, long estimatedTimeLeft, float ratioOfDone) {
