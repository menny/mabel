...
def generate_transitive_dependency_targets(
    ...
    jvm_import(
        name = "com_squareup_moshi__moshi_kotlin_codegen__1_9_2",
        jars = ["@com_squareup_moshi__moshi_kotlin_codegen__1_9_2//file"],
        testonly = False,
        tags = [
            "mabel_license_detected_type=Apache",
            "mabel_license_name=Apache 2.0",
            "mabel_license_url=http://www.apache.org/licenses/LICENSE-2.0.txt",
            "maven_coordinates=com.squareup.moshi:moshi-kotlin-codegen:1.9.2",
        ],
        licenses = ["notice"],
        deps = [
    ...
    # from com.squareup.moshi:moshi:1.9.2
    # This is a dependency of 'com.squareup.moshi:moshi-kotlin-codegen:1.9.2'.
    native.alias(
    ...
    jvm_import(
        ...
        tags = [
            ...
            "mabel_license_name=Apache 2.0",
            "mabel_license_url=http://www.apache.org/licenses/LICENSE-2.0.txt",
            "maven_coordinates=com.squareup.moshi:moshi:1.9.2",
        ],
        licenses = ["notice"],
    ...
    # from com.squareup.okio:okio:1.16.0
    # This is a dependency of 'com.squareup.moshi:moshi:1.9.2'.
    native.alias(
    ...
    jvm_import(
        ...
        tags = [
            ...
            "mabel_license_name=Apache 2.0",
            "mabel_license_url=http://www.apache.org/licenses/LICENSE-2.0.txt",
            "maven_coordinates=com.squareup.okio:okio:1.16.0",
        ],
        licenses = ["notice"],
        deps = [],
        exports = [],
    ...
    jvm_import(
        name = "com_squareup__kotlinpoet__1_4_4",
        jars = ["@com_squareup__kotlinpoet__1_4_4//file"],
        testonly = False,
        tags = [
            "mabel_license_detected_type=Apache",
            "mabel_license_name=The Apache Software License, Version 2.0",
            "mabel_license_url=http://www.apache.org/licenses/LICENSE-2.0.txt",
            "maven_coordinates=com.squareup:kotlinpoet:1.4.4",
        ],
        licenses = ["notice"],
        deps = [":org_jetbrains_kotlin__kotlin_stdlib_jdk7"],
        exports = [],
        runtime_deps = [":org_jetbrains_kotlin__kotlin_reflect"],
    )

    # from org.jetbrains.kotlin:kotlin-reflect:1.3.50
    # This is a dependency of 'com.squareup:kotlinpoet:1.4.4'.
    native.alias(
    ...
    jvm_import(
        name = "org_jetbrains_kotlin__kotlin_reflect__1_3_50",
        jars = ["@org_jetbrains_kotlin__kotlin_reflect__1_3_50//file"],
        testonly = False,
        tags = [
            "mabel_license_detected_type=Apache",
            "mabel_license_name=The Apache License, Version 2.0",
            "mabel_license_url=http://www.apache.org/licenses/LICENSE-2.0.txt",
            "maven_coordinates=org.jetbrains.kotlin:kotlin-reflect:1.3.50",
        ],
        licenses = ["notice"],
        deps = [":org_jetbrains_kotlin__kotlin_stdlib"],
        exports = [],
        runtime_deps = [],
    )
    ...
    jvm_import(
        name = "org_jetbrains_kotlin__kotlin_stdlib_jdk7__1_3_50",
        jars = ["@org_jetbrains_kotlin__kotlin_stdlib_jdk7__1_3_50//file"],
        testonly = False,
        tags = [
            "mabel_license_detected_type=Apache",
            "mabel_license_name=The Apache License, Version 2.0",
            "mabel_license_url=http://www.apache.org/licenses/LICENSE-2.0.txt",
            "maven_coordinates=org.jetbrains.kotlin:kotlin-stdlib-jdk7:1.3.50",
        ],
        licenses = ["notice"],
        deps = [":org_jetbrains_kotlin__kotlin_stdlib"],
        exports = [],
    ...
    # This is a root requested Maven artifact.
    # This is a dependency of 'com.squareup.moshi:moshi-kotlin-codegen:1.9.2'.
    # This is a dependency of 'org.jetbrains.kotlin:kotlin-reflect:1.3.50'.
    # This is a dependency of 'org.jetbrains.kotlin:kotlin-stdlib-jdk7:1.3.50'.
    native.alias(
