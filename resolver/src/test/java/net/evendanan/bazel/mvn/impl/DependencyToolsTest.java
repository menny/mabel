...
public class DependencyToolsTest {
  ...
  public void testMavenFunctions() {
    Dependency dependency =
        Dependency.builder()
            .mavenCoordinate(MavenCoordinate.create("net.group", "some_lib", "1.2", "jar"))
            .build();
  ...
  public void testLicenseTypeParsing() {
    ...
    Assert.assertEquals(
        "Apache",
        LicenseTools.typeFromLicenseName(
    ...
    Assert.assertEquals(
        "Apache", LicenseTools.typeFromLicenseName("The Apache Software License, Version 2.0"));
    ...
    Assert.assertEquals(
        "Common-Public", LicenseTools.typeFromLicenseName("Common Public License Version 1.0"));
    Assert.assertEquals(
        "CDDL", LicenseTools.typeFromLicenseName("CDDL + GPLv2 with classpath exception"));
    ...
    Assert.assertEquals(
        "Google Cloud", LicenseTools.typeFromLicenseName("Google Cloud Software License"));
    Assert.assertEquals(
        "Indiana University",
        LicenseTools.typeFromLicenseName(
    ...
    Assert.assertEquals(
        "Indiana University",
        LicenseTools.typeFromLicenseName("Indiana University Extreme! Lab Software License"));
    ...
    Assert.assertEquals(
        "Eclipse", LicenseTools.typeFromLicenseName("Eclipse Public License v 1.0"));
    Assert.assertEquals(
        "Eclipse", LicenseTools.typeFromLicenseName("Eclipse Public License, Version 1.0"));
    ...
    Assert.assertEquals(
        "GPL", LicenseTools.typeFromLicenseName("GNU LESSER GENERAL PUBLIC LICENSE, Version 2.1"));
    ...
    Assert.assertEquals(
        "AOSP", LicenseTools.typeFromLicenseName("Android Software Development Kit License"));
    Assert.assertEquals(
        "NO-WARRANTY", LicenseTools.typeFromLicenseName("provided without support or warranty"));
  ...
  public void testLicenseClassParsing() {
    ...
    Assert.assertEquals(
        License.Class.notice, LicenseTools.classFromLicenseName("Bouncy Castle Licence"));
    Assert.assertEquals(License.Class.notice, LicenseTools.classFromLicenseName("New BSD License"));
    Assert.assertEquals(
        License.Class.notice, LicenseTools.classFromLicenseName("BSD 2-Clause License"));
    ...
    Assert.assertEquals(
        License.Class.notice, LicenseTools.classFromLicenseName("The JSON License"));
    Assert.assertEquals(
        License.Class.notice,
        LicenseTools.classFromLicenseName("Common Public License Version 1.0"));
    Assert.assertEquals(
        License.Class.notice,
    ...
    Assert.assertEquals(
        ...
        LicenseTools.classFromLicenseName("Eclipse Public License v 1.0"));
    Assert.assertEquals(
        License.Class.reciprocal,
    ...
    Assert.assertEquals(
        License.Class.reciprocal, LicenseTools.classFromLicenseName("Mozilla License"));
    ...
    Assert.assertEquals(
        License.Class.unencumbered, LicenseTools.classFromLicenseName("Public Domain"));
    Assert.assertEquals(
  ...
  public void testAutoValueLicenseCreate() {
    Assert.assertEquals(
        "License", License.create("License", "https://example.com/license.txt").name());
    Assert.assertEquals(
        "https://example.com/license.txt",
        License.create("License", "https://example.com/license.txt").url());
