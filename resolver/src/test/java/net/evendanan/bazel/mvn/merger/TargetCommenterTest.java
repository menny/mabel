...
public class TargetCommenterTest {
    ...
    mResolvedDependencies =
        Arrays.asList(
            ...
            Dependency.builder()
                ...
                .build(),
            Dependency.builder()
                .mavenCoordinate(MavenCoordinate.create("a.b.c.1", "d", "1.1.1", "jar"))
                .build(),
            Dependency.builder()
                .mavenCoordinate(MavenCoordinate.create("a.b.c.2", "d", "1.1.1", "jar"))
                .dependencies(
                    Collections.singleton(MavenCoordinate.create("a.b.c.2.1", "d", "1.1.1", "jar")))
                .exports(
                    Collections.singleton(MavenCoordinate.create("a.b.c.2.1", "d", "1.1.1", "jar")))
                .build(),
            Dependency.builder()
                .mavenCoordinate(MavenCoordinate.create("b.c.d.1", "e", "2.1.1", "jar"))
                .build(),
            Dependency.builder()
                .mavenCoordinate(MavenCoordinate.create("c.d.e.1", "f", "3.1.1", "jar"))
                .build(),
            Dependency.builder()
                .mavenCoordinate(MavenCoordinate.create("c.d.e.2", "f", "3.1.1", "jar"))
                .dependencies(
                    Arrays.asList(
                ...
                .build(),
            Dependency.builder()
                .mavenCoordinate(MavenCoordinate.create("c.d.e.2.1", "f", "3.1.1", "jar"))
                .build(),
            Dependency.builder()
                .mavenCoordinate(MavenCoordinate.create("c.d.e.2.2", "f", "3.1.1", "jar"))
                .build(),
            Dependency.builder()
                .mavenCoordinate(MavenCoordinate.create("a.b.c.2.1", "f", "3.1.1", "jar"))
                .build());
  ...
  public void testDelegateToBase() {
    ...
    final List<Target> targets =
        mUnderTest
            .createTargetBuilder(mMockBaseBuilder)
            .buildTargets(mResolvedDependencies.get(0), mDependencyTools);
    Mockito.verify(mMockBaseBuilder)
        .buildTargets(Mockito.same(mResolvedDependencies.get(0)), Mockito.same(mDependencyTools));
  ...
  public void testAddsCommentIfDependencyIsRequiredByRootDependency() {
    ...
    List<String> comments = new ArrayList<>(target.getComments());
    Assert.assertEquals(
        "This is a dependency of '" + mRootDependencies.get(0).toMavenString() + "'.",
        comments.get(0));
  }
  ...
  private static Target createTarget(MavenCoordinate mavenCoordinate) {
    return new Target(
        mavenCoordinate.toMavenString(), "rule", mavenCoordinate.toMavenString().replace(":", "_"));
  }
}
