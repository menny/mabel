...
public class ArtifactDownloaderTest {
  ...
  public void setup() throws Exception {
    ...
    mUnderTest =
        new ArtifactDownloader(mTestOpener, artifactDownloaderFolder, DependencyTools.DEFAULT);
    ...
    mDependency =
        Dependency.builder()
            ...
            .build();
    expectedOutputFile =
        new File(artifactDownloaderFolder, DependencyTools.DEFAULT.repositoryRuleName(mDependency));
  }
