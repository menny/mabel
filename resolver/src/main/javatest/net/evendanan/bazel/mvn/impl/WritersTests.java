...
public class WritersTests {
    ...
    private static final String TRANSITIVE_TARGETS_MACRO_OUTPUT = "# Transitive rules macro to be run in the BUILD.bazel file.\n" +
            ...
            "\n" +
            "\n";
    private static final String ALIAS_DEP_1 = "#Auto-generated by https://github.com/menny/mabel\n"
            + "# for artifact net.evendanan.dep1:artifact\n\n"
            + "alias(name = 'artifact',\n"
            + "    actual = '//path/to/bzl:name_name_1',\n"
            + "    visibility = ['//visibility:public'],\n"
            + ")\n\n";
    private static final String ALIAS_DEP_2 = "#Auto-generated by https://github.com/menny/mabel\n"
            + "# for artifact net.evendanan.dep2:artifact\n\n"
            + "alias(name = 'artifact',\n"
            + "    actual = '//path/to/bzl:name_name_2',\n"
            + "    visibility = ['//visibility:public'],\n"
            + ")\n\n";
    private static final String ALIAS_DEP_2_MULTIPLE = "#Auto-generated by https://github.com/menny/mabel\n" +
            "# for artifact net.evendanan.dep2:artifact\n\n" +
            "alias(name = 'artifact',\n" +
            "    actual = '//path/to/bzl:name_name_2',\n" +
            "    visibility = ['//visibility:public'],\n" +
            ...
            ")\n" +
            "\n";
    private static final String ALIAS_DEP_IGNORES_VERSIONS = "#Auto-generated by https://github.com/menny/mabel\n" +
            "# for artifact net.evendanan.dep1:artifact\n\n" +
            "alias(name = 'artifact',\n" +
            "    actual = '//path/to/bzl:name_name_1',\n" +
            "    visibility = ['//visibility:public'],\n" +
    ...
    public void testRepositoryRulesMacroWriterWithSources() throws Exception {
        final List<Target> targets = new TargetsBuilders.HttpTargetsBuilder(false, dep -> URI.create("")).buildTargets(
                Dependency.builder()
                        ...
                        .sourcesUrl("https://maven.central.org/repo/net/evendanan/dep1/dep1-1.2.3-sources.jar")
                        .build(),
    ...
    public void testRepositoryRulesMacroWriterWithSha() throws Exception {
        ...
        final List<Target> targets = httpTargetsBuilder.buildTargets(Dependency.builder()
                        .mavenCoordinate(MavenCoordinate.create("net.evendanan", "dep1", "1.2.3", "jar"))
                        .url("https://maven.central.org/repo/net/evendanan/dep1/dep1-1.2.3.jar")
                        .build(),
                DependencyTools.DEFAULT);
    ...
    public void testRepositoryRulesMacroWriterWithShaButDoesNotGeneratesIfVersionIsSnapshot() throws Exception {
        ...
        final List<Target> targets = httpTargetsBuilder.buildTargets(Dependency.builder()
                        .mavenCoordinate(MavenCoordinate.create("net.evendanan", "dep1", "1.2.3-SNAPSHOT", "jar"))
