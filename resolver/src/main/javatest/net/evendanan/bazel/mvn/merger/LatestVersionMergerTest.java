...
public class LatestVersionMergerTest {
    ...
    public void testHappyPath() throws Exception {
        ...
        Assert.assertTrue(
                dep1.dependencies().stream()
                        .allMatch(
                                d -> d.artifactId().equals("inner1") && d.version().equals("0.2")));
        Assert.assertTrue(
    ...
    public void testPinRootVersion() throws Exception {
        ...
        Collection<Dependency> resolved =
                mUnderTest.mergeGraphs(Arrays.asList(root1, root2, root3));
        Assert.assertEquals(3, resolved.size());
        Dependency dep1 =
                resolved.stream()
                        .filter(d -> d.mavenCoordinate().artifactId().equals("dep1"))
        ...
        Assert.assertTrue(
                dep1.dependencies().stream()
                        ...
                        .allMatch(
                                d -> d.artifactId().equals("inner1") && d.version().equals("0.1")));
        Assert.assertTrue(
                dep2.dependencies().stream()
                        .allMatch(
                                d -> d.artifactId().equals("inner1") && d.version().equals("0.1")));
