    ...
    public void testExcludes_NoRemovalIfEmptyExclude() {
        ...
        actual.forEach(
                dep ->
                        Assert.assertTrue(
                                containsDependency(
                                        mBasicResolution.allResolvedDependencies(), dep)));
                ...
                dep ->
                        Assert.assertTrue(
                                containsDependency(mBasicResolution.allResolvedDependencies(), dep)
                                        || containsDependency(
                                        secondResolution.allResolvedDependencies(), dep)));
    }
