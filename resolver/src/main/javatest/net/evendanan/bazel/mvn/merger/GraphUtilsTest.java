...
public class GraphUtilsTest {
    ...
    public void testDoesNotTravelCircle() {
        ...
        GraphUtils.DfsTraveller(Collections.singleton(resolution), (dependency, integer) -> Assert.assertTrue(dependency.mavenCoordinate().toMavenString(), seen.add(dependency.mavenCoordinate())));
