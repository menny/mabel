...
public class FormattersTests {
    ...
    private static final String JAVA_PLUGIN_TEXT = "    native.java_import(\n"
                                                   + "        name = \"mvn__aar_lib_java_plugin_lib\",\n"
                                                   ...
                                                   + "        )\n"
                                                   + "    native.java_plugin(\n"
                                                   + "        name = \"mvn__aar_lib_generate_api_0\",\n"
                                                   + "        processor_class = \"com.example.Processor\",\n"
                                                   + "        generates_api = 1,\n"
                                                   + "        deps = [\n"
                                                   + "            \":mvn__aar_lib_java_plugin_lib\",\n"
                                                   ...
                                                   + "        )\n"
                                                   + "    native.java_plugin(\n"
                                                   + "        name = \"mvn__aar_lib_generate_api_1\",\n"
                                                   + "        processor_class = \"com.example.Processor2\",\n"
                                                   + "        generates_api = 1,\n"
                                                   + "        deps = [\n"
                                                   + "            \":mvn__aar_lib_java_plugin_lib\",\n"
    ...
    private static final String KOTLIN_IMPORT_TEXT = "    kt_jvm_import(\n"
                                                     + "        name = \"mvn__kotlin_lib_kotlin_jar\",\n"
