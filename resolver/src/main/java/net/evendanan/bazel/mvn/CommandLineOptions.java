...
public class CommandLineOptions {
  ...
  @Parameter(
      ...
      description =
          "Which version-conflict resolution strategy to use. Default is 'latest_version'. Can be:"
              + " 'latest_version', 'breadth_first', 'depth_first'.",
      required = true)
  ...
  @Parameter(
      ...
      splitter = NoSplitter.class,
      description =
          "Where to generate exports: all, requested_deps, none. Note: Can not be inherit for this"
              + " call.",
      required = true)
