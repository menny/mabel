...
public class DefaultModelResolver implements ModelResolver {
    ...
    public Model getEffectiveModel(ModelSource modelSource) {
        ...
        try {
            ...
            System.out.println("Unable to build Maven model from " + modelSource.getLocation()
                    + ": " + e.getMessage());
            return null;
        }
        ...
        try {
            ...
            System.out.println("Unable to resolve effective Maven model from " + modelSource.getLocation()
                    + ": " + e.getMessage());
            return null;
        }
