...
public class DefaultModelResolver implements ModelResolver {
  ...
  public DefaultModelResolver(
    ...
    this(
        ...
        new DefaultModelBuilderFactory()
            .newInstance()
            .setProfileSelector(
                new DefaultProfileSelector().addProfileActivator(new PropertyProfileActivator())),
        versionResolver,
        jdkHome);
  }
  ...
  public Model getEffectiveModel(ModelSource2 modelSource) {
    ...
    request
        .getSystemProperties()
        .setProperty("java.home", jdkHome); // required for tools.jar resolve
    ...
    try {
      ...
      throw new RuntimeException(
          "Failed to resolve effective model for " + modelSource.getLocationURI(), e);
    }
  }
