...
public class Aether {
  ...
  /**
   * A set of utility methods for creating repository systems, repository system sessions and remote
   * repositories.
   */
  static class Utilities {
     ...
     *
     * <p>TODO(petros): Separate this out into its own class. This is the most intricate element of
     * Aether. There are various settings that are useful to us. Specifically, these are the (1)
     * LocalRepositoryManager, (2) DependencyManager, (3) DependencyGraphTransformer, (4)
