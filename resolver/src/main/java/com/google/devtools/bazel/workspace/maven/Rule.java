...
public class Rule implements Comparable<Rule> {
  ...
  private static final CharMatcher DOT_OR_DASH = CharMatcher.anyOf(".-");
  ...
  /**
   * A unique name for this artifact which includes Maven meta-data. This can later be decoded back
   * into a maven annotation. Should be used as the name of a lib, never an external workspace
   */
